...
<head>
    ...
    <title>Register - Waterpool Suites</title>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-7 col-sm-10 transparent-container">
                    <h2 class="fw-bold h-font text-center" style="font-size: 2.5rem;">Sign Up</h2>
                    ...
                    <br>
                    <p>Already have an account? <a href="login.php" class="no-underline">Login</a></p>
                </div>
            </div>
        </div>
    </div>
